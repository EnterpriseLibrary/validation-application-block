<%@ page language="C#" autoeventwireup="true" inherits="_Default, App_Web_y5sb5ace" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <entlibvalidation:PropertyProxyValidator ID="PropertyValidatorProxyControl" runat="server"
                SourceTypeName="EnterpriseLibrary.Validation.TestSupport.TestClasses.TestObjectWithFailingAttributesOnProperties, EnterpriseLibrary.Validation.TestSupport" PropertyName="FailingProperty1" ControlToValidate="Name"
